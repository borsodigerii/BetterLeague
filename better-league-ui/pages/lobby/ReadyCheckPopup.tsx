        ...
        <div className={style.readyCheckBackdrop}>
            <div className={style.readyCheckContainer}>
                <div className={style.readyCheck}>
                    ...
                    <button onClick={() => props.handler(ReadyCheckState.Accepted)} disabled={(props.status != ReadyCheckState.Popup ? true : false)}>Accept</button>
                    <button onClick={() => props.handler(ReadyCheckState.Declined)} disabled={(props.status != ReadyCheckState.Popup ? true : false)}>Decline</button>
                </div>
            </div>
        </div>
